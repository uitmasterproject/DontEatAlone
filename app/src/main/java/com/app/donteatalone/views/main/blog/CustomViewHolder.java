...
public class CustomViewHolder extends ViewHolder {
    ...
    protected RelativeLayout rlDelete, rlSharefb;
    ...
    public CustomViewHolder(View itemView) {
        ...
        rlDelete = (RelativeLayout) itemView.findViewById(R.id.custom_adapter_recyclerview_my_status_blog_imgbtn_delete);
        rlSharefb = (RelativeLayout) itemView.findViewById(R.id.custom_adapter_recyclerview_my_status_blog_imgbtn_share_fb);
